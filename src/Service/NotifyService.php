...
class NotifyService
{
    public function __construct(private readonly LoggerInterface $logger, private readonly NotifierInterface $notifier, private readonly string $mailerTo, private readonly string $phoneNumber)
    {
    }
